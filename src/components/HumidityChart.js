...
import './styles/HumidityChart.css';
...
const HumidityChart = ({ data }) => {
  // Création des échelles pour les axes X (temps) et Y (humidité)
  ...
  const yScale = scaleLinear({
    range: [yMax, 0],
    domain: [0, max(data, (d) => d.humidity) + 5], // Ajouter une marge en haut
  });
